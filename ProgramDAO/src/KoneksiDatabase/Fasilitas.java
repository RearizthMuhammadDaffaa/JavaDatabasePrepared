...
public class Fasilitas {
        ...
        try{
            ...
            prepare.setString(2,barang.getNama_barang());
             prepare.setInt(3,barang.getJumlah());
              prepare.setInt(4,barang.getHarga());
    ...
    public void delete(String kode_barang){
        ...
        try{
            ...
            prepare.executeUpdate();
            System.out.println("Prepare Berhasil ");
        }catch(SQLException ex){
            System.out.println("Prepare Statement gagal dibuat");
            System.out.println("Pesan : "+ex.getMessage());
        }finally{
    ...
    public List<barang> selectALL(){
       ...
       try{
           ...
           System.out.println("Prepare berhasil dibuat");
           return list;
       }catch(SQLException ex){
            System.out.println("Prepare Statement gagal dibuat");
            System.out.println("Pesan : "+ex.getMessage());
             ...
             if(prepare != null){
                    try{
                        prepare.close();
                        System.out.println("prepare Berhasil ditutup");
                        
                    }
                    catch(SQLException ex){
                        System.out.println("prepare gagal ditutup");
                        System.out.println("Pesan : "+ex.getMessage());
